...
# Configuration
cfg = {
    "model_name": "Salesforce/blip2-flan-t5-xxl", # "Salesforce/blip2-opt-2.7b" or "Salesforce/blip2-opt-6.7b" or "Salesforce/blip2-flan-t5-xl" or "Salesforce/blip2-flan-t5-xxl"
    ...
    "act_ckpt": True, # uses gradient_checkpointing_enable() on single GPU, FSDP policies on multi-GPU
    "max_epochs": 2,
    "max_steps": -1,
    "devices": 1,
    "strategy": "auto",
